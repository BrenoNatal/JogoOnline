...
public class JogoOnlineTest {
    ...
    @Test
    public void testarLoginComUsuarioDesconhecido1() {
        try {
    ...
    public void testarLoginComUsuarioDesconhecido2() throws SenhaInvalidaException, UsuarioInexistenteException {
    ...
    public void testarLogoutDeJogadorNaoOnline1() {
        Jogador jogadoraMaria = jogo.cadastrarJogador("maria", "3456");

        jogo.fazerLogout(jogadoraMaria);
        // impossível fazer o logout de jogador que não está online,
